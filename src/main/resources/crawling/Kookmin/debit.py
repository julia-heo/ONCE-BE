...
df.to_csv("src/main/java/ewha/lux/once/domain/card/service/crawling/Kookmin/debit_benefit.csv", encoding = "utf-8-sig", index=False)
print(datetime.now().strftime("%Y-%m-%d %H:%M:%S")+" 국민카드 체크카드 크롤링 완료", flush=True)